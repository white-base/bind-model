...
declare abstract class BaseBindCommand extends MetaElement {
     ...
     * 
     * @param bind - 전송할 `MetaView` 객체입니다.
     * @param cmd - 현재 바인드 명령 객체입니다.
     * @param setup - 설정 객체입니다.
     */
     ...
     * 주로 결과 데이터 가공에 사용됩니다.
     * 
     * @param data - 바인드 결과 데이터입니다.
     * @param cmd - 현재 바인드 명령 객체입니다.
     * @param response - response 객체입니다.
     ...
     * 주로 목록의 출력에 사용됩니다.
     * 
     * @param views - 출력 뷰 컬렉션입니다. (_outputs)
     * @param cmd - 현재 바인드 명령 객체입니다.
     * @param response - response 객체입니다.
     */
     ...
     * @param name - 컬럼 이름입니다.
     * @param value - 컬럼 값입니다.
     * @param views - (선택적) 추가할 뷰 엔티티 이름입니다.
     * @param bTable - (선택적) 매핑할 기본 테이블 객체 또는 테이블 이름입니다.
     */
     ...
     * 컬럼을 설정합니다.
     * 
     * @param name - 컬럼 이름 또는 이름 배열입니다.
     * @param views - 설정할 뷰 이름 또는 이름 배열입니다.
     * 
     * @example
     ...
     * 대상 엔티티에서 컬럼을 해제합니다.
     * 
     * @param name - 해제할 컬럼 이름 또는 이름 배열입니다.
     * @param views - 해제할 뷰 엔티티 이름 또는 이름 배열입니다.
     */
     ...
     * 
     * @param name - (선택적) 추가로 참조할 뷰 이름입니다.
     */
