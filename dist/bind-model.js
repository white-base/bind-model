/*! Logic Core v1.1.2 Copyright (c) 2025 logicfeel and contributors */
(function (global, factory) {
  ...
  //==============================================================
  var isNode$2 = typeof globalThis.isDOM === 'boolean' ? !globalThis.isDOM : typeof process !== 'undefined' && process.versions !== null && process.versions.node !== null;
  function loadJSON(_x) {
    return _loadJSON.apply(this, arguments);
  }
  function _loadJSON() {
    _loadJSON = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee(filePath) {
      var _yield$import, readFile, absolutePath, jsonText, _absolutePath, response;
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          ...
          case 4:
            ...
            readFile = _yield$import.readFile;
            _context.next = 8;
            return getLocalePath(filePath);
          case 8:
            absolutePath = _context.sent;
            _context.next = 11;
            return readFile(absolutePath, 'utf8');
          case 11:
            jsonText = _context.sent;
            return _context.abrupt("return", JSON.parse(jsonText));
          case 15:
            _context.next = 17;
            return getLocalePath(filePath);
          case 17:
            _absolutePath = _context.sent;
            _context.next = 20;
            return fetch(_absolutePath);
          case 20:
  ...
  function getLocalePath(_x2) {
    return _getLocalePath.apply(this, arguments);
  }
  function _getLocalePath() {
    _getLocalePath = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee2(filename) {
      var _yield$import2, fileURLToPath, path, __filename, __dirname, baseURL;
      return _regeneratorRuntime().wrap(function _callee2$(_context2) {
        while (1) switch (_context2.prev = _context2.next) {
          ...
          case 3:
            ...
            fileURLToPath = _yield$import2.fileURLToPath;
            _context2.next = 7;
            return import('path');
          case 7:
            path = _context2.sent;
            __filename = fileURLToPath((typeof document === 'undefined' && typeof location === 'undefined' ? require('u' + 'rl').pathToFileURL(__filename).href : typeof document === 'undefined' ? location.href : (_documentCurrentScript && _documentCurrentScript.tagName.toUpperCase() === 'SCRIPT' && _documentCurrentScript.src || new URL('bind-model.js', document.baseURI).href)));
            __dirname = path.dirname(__filename);
            return _context2.abrupt("return", path.resolve(__dirname, filename));
          case 11:
          ...
          case 17:
            ...
            baseURL = (typeof document === 'undefined' && typeof location === 'undefined' ? require('u' + 'rl').pathToFileURL(__filename).href : typeof document === 'undefined' ? location.href : (_documentCurrentScript && _documentCurrentScript.tagName.toUpperCase() === 'SCRIPT' && _documentCurrentScript.src || new URL('bind-model.js', document.baseURI).href));
            _context2.next = 22;
            break;
          case 21:
            throw new Error('Unable to determine base URL in browser.');
          case 22:
            return _context2.abrupt("return", new URL(filename, baseURL).href);
          case 23:
          ...
          return _regeneratorRuntime().wrap(function _callee$(_context) {
            while (1) switch (_context.prev = _context.next) {
              ...
              case 4:
                ...
                localPath = this.$storage.path[i]; // var msg = await loadJSON(`${localPath}/${p_lang}.json`);
                // initialize the language
                this.$storage.lang[p_lang] = this.$storage.lang[p_lang] || {};
                this.$storage._history[p_lang] = this.$storage._history[p_lang] || [];
                _history = this.$storage._history[p_lang];
                if (!(_history.indexOf(localPath) >= 0)) {
                  _context.next = 11;
                  break;
                }
              ...
              case 13:
                ...
                } else console.warn("Path '".concat(localPath, "/").concat(p_lang, ".json' does not have a file."));
              case 15:
                i++;
                _context.next = 4;
                break;
  ...
  var localesPath$2 = './locales'; // 상대 경로
  ...
  _defineProperty(IObject, "_NS", 'Interface');
  // namespace
  _defineProperty(IObject, "_KIND", 'interface');
   ...
   * @interface
   */
  var IMarshal = /*#__PURE__*/function () {
    /**
     * @constructs IMarshal
     */
    function IMarshal() {
      _classCallCheck(this, IMarshal);
      /**
       * Internal property that stores the unique identifier of the object.
       * 
       * @member {string}
       */
      _defineProperty(this, "_guid", String);
      /**
       * Internal property that stores the creator type of the object.
       * 
       * @member {string} REVIEW:
       */
      _defineProperty(this, "_type", [['_req_', Function, {
        $type: 'class'
      }]]);
    }
    return _createClass(IMarshal, [{
      key: "getObject",
      value:
      /**
  ...
  _defineProperty(IMarshal, "_NS", 'Interface');
  // namespace
  _defineProperty(IMarshal, "_KIND", 'interface');
   ...
   * @interface
   */
  var ICollection = /*#__PURE__*/function () {
    // namespace
     ...
     * @abstract
     */
    return _createClass(ICollection, [{
      key: "add",
      value: function add() {
  ...
  _defineProperty(ICollection, "_KIND", 'interface');
  _defineProperty(ICollection, "_NS", 'Interface');
   ...
   * @extends ICollection
   */
  var IPropertyCollection = /*#__PURE__*/function (_ICollection) {
    // namespace

    function IPropertyCollection() {
      _classCallCheck(this, IPropertyCollection);
      return _callSuper(this, IPropertyCollection);
    }
     ...
     * @abstract
     */
    _inherits(IPropertyCollection, _ICollection);
    return _createClass(IPropertyCollection, [{
      key: "indexToKey",
      value: function indexToKey() {
        throw new ExtendError(/EL02181/, null, ['IPropertyCollection']);
      }
    }]);
  }(ICollection);
  _defineProperty(IPropertyCollection, "_KIND", 'interface');
  _defineProperty(IPropertyCollection, "_NS", 'Interface');
  ...
  var IElement = /*#__PURE__*/function () {
    ...
    function IElement() {
       ...
       * @member {string}
       */
      _defineProperty(this, "_name", String);
    }
    return _createClass(IElement, [{
      key: "clone",
      value:
      /**
  ...
  _defineProperty(IElement, "_NS", 'Interface');
  // namespace
  _defineProperty(IElement, "_KIND", 'interface');
   ...
   * @interface
   */
  var IList = /*#__PURE__*/_createClass(
  /**
   * @constructs IList
   */
  function IList() {
     ...
     * @member {array}
     */
    _defineProperty(this, "_list", Array);
    /**
     * Returns the number of lists.
     * 
     * @member {number}
     */
    _defineProperty(this, "count", Number);
  });
  _defineProperty(IList, "_NS", 'Interface');
  // namespace
  _defineProperty(IList, "_KIND", 'interface');
   ...
   * @interface
   */
  var IListControl = /*#__PURE__*/function () {
    function IListControl() {
      _classCallCheck(this, IListControl);
    }
     ...
     * @abstract
     */
    return _createClass(IListControl, [{
      key: "add",
      value: function add() {
  ...
  _defineProperty(IListControl, "_NS", 'Interface');
  // namespace
  _defineProperty(IListControl, "_KIND", 'interface');
   ...
   * @interface
   */
  var ISerialize = /*#__PURE__*/function () {
    /**
     * @constructs ISerialize
     */
    function ISerialize() {
      _classCallCheck(this, ISerialize);
    }
     ...
     * @abstract
     */
    return _createClass(ISerialize, [{
      key: "output",
  ...
  _defineProperty(ISerialize, "_NS", 'Interface');
  // namespace
  _defineProperty(ISerialize, "_KIND", 'interface');
   ...
   * @extends ICollection
   */
  var IArrayCollection = /*#__PURE__*/function (_ICollection) {
    // namespace

    function IArrayCollection() {
      _classCallCheck(this, IArrayCollection);
      return _callSuper(this, IArrayCollection);
    }
     ...
     * @abstract
     */
    _inherits(IArrayCollection, _ICollection);
    return _createClass(IArrayCollection, [{
      key: "insertAt",
  ...
  _defineProperty(IArrayCollection, "_KIND", 'interface');
  _defineProperty(IArrayCollection, "_NS", 'Interface');
  ...
  var isNode$1 = typeof globalThis.isDOM === 'boolean' ? !globalThis.isDOM : typeof process !== 'undefined' && process.versions !== null && process.versions.node !== null;
  var localesPath$1 = './locales';
  function absolutePath$1(localPath) {
    try {
  ...
  if (isNode$1) {
    localesPath$1 = absolutePath$1(localesPath$1);
  }
   ...
   */
  var IExportControl = /*#__PURE__*/function () {
    function IExportControl() {
      _classCallCheck(this, IExportControl);
    }
    return _createClass(IExportControl, [{
      key: "write",
      value:
      /**
       * 대상을 내보냅니다. (쓰기)
  ...
  _defineProperty(IExportControl, "_NS", 'Interface');
  // namespace
  _defineProperty(IExportControl, "_KIND", 'interface');
   ...
   */
  var IGroupControl = /*#__PURE__*/function () {
    function IGroupControl() {
      _classCallCheck(this, IGroupControl);
    }
    return _createClass(IGroupControl, [{
      key: "merge",
      value:
      /**
       * 병합합니다.
  ...
  _defineProperty(IGroupControl, "_NS", 'Interface');
  // namespace
  _defineProperty(IGroupControl, "_KIND", 'interface');
   ...
   */
  var IImportControl = /*#__PURE__*/function () {
    function IImportControl() {
      _classCallCheck(this, IImportControl);
    }
    return _createClass(IImportControl, [{
      key: "read",
      value:
      /**
       * 대상을 가져옵니다. (읽기)
  ...
  _defineProperty(IImportControl, "_NS", 'Interface');
  // namespace
  _defineProperty(IImportControl, "_KIND", 'interface');
   ...
   */
  var ISchemaControl = /*#__PURE__*/function () {
    function ISchemaControl() {
      _classCallCheck(this, ISchemaControl);
    }
    return _createClass(ISchemaControl, [{
      key: "readSchema",
      value:
      /**
       * 스키마를 가져옵니다.
      ...
      key: "writeSchema",
      value: function writeSchema() {
        throw new ExtendError(/EL02242/, null, ['ISchemaControl']);
      }
    }]);
  }();
  _defineProperty(ISchemaControl, "_NS", 'Interface');
  // namespace
  _defineProperty(ISchemaControl, "_KIND", 'interface');
   ...
   */
  var ITransaction = /*#__PURE__*/function () {
    function ITransaction() {
      _classCallCheck(this, ITransaction);
    }
    return _createClass(ITransaction, [{
      key: "acceptChanges",
      value:
      /**
       * 변경을 수락합니다. (commit)
  ...
  _defineProperty(ITransaction, "_NS", 'Interface');
  // namespace
  _defineProperty(ITransaction, "_KIND", 'interface');
    ...
    BaseEntity.prototype._buildEntity = function (p_entity, p_callback, p_items) {
      ...
      try {
        ...
        for (var k = 0; k < orignal.rows.count; k++) {
          if (!p_callback || typeof p_callback === 'function' && p_callback.call(this, orignal.rows[k], k, p_entity)) {
  ...
  var isNode = typeof globalThis.isDOM === 'boolean' ? !globalThis.isDOM : typeof process !== 'undefined' && process.versions !== null && process.versions.node !== null;
  ...
  if (isNode) {
    absolutePath(localesPath), _readOnlyError("localesPath");
  }
   ...
   */
  Util.validSelector = function validSelector(p_selector) {
    // COVER:
    // var selectors = [];

    // selector 얻기
    if (!_isString(p_selector)) return false;
    if ((typeof document === "undefined" ? "undefined" : _typeof(document)) === 'object' && typeof document.querySelector === 'function') {
  ...
  Util.loadScript = function loadScript(url, callback) {
    ...
    if ((typeof document === "undefined" ? "undefined" : _typeof(document)) !== 'object') throw new ExtendError(/EL01613/, null, []);
  ...
  var IBind = /*#__PURE__*/function () {
    function IBind() {
       ...
       * @member {MetaTable}
       */
      _defineProperty(this, "_baseTable", [['_any_']]);
    }
    return _createClass(IBind, [{
      key: "addColumn",
      value:
      /**
       * 대상을 내보냅니다. (쓰기)
  ...
  _defineProperty(IBind, "_NS", 'Interface');
  // namespace
  _defineProperty(IBind, "_KIND", 'interface');
   ...
   */
  var IBindCommand = /*#__PURE__*/function () {
    function IBindCommand() {
      _classCallCheck(this, IBindCommand);
      /**
       * 유효성 뷰
       * 
       * @member {MetaView}
       */
      _defineProperty(this, "valid", {});
      /**
       * 바인드 뷰
       * 
       * @member {MetaView}
       ...
       * @member {object}
       */
      _defineProperty(this, "outputOption", {
        option: Number,
        index: [[[Number], Number]]
      });
    }
    return _createClass(IBindCommand, [{
      key: "execute",
      value:
      /**
       * 대상을 내보냅니다. (쓰기)
  ...
  _defineProperty(IBindCommand, "_NS", 'Interface');
  // namespace
  _defineProperty(IBindCommand, "_KIND", 'interface');
   ...
   */
  var IBindModel = /*#__PURE__*/_createClass(function IBindModel() {
    _classCallCheck(this, IBindModel);
    /**
     * 아이템
     * 
     * @member {object[][]}
     ...
     * @member {Function[][]}
     */
    _defineProperty(this, "preRegister", [[Function]]);
    /**
     * 초기화 이전 검사
     * 
     * @member {Function[][]}
     */
    _defineProperty(this, "preCheck", [[Function]]);
    /**
     * 초기화 이전 준비완료
     * 
     * @member {Function[][]}
     */
    _defineProperty(this, "preReady", [[Function]]);
  });
  _defineProperty(IBindModel, "_NS", 'Interface');
  // namespace
  _defineProperty(IBindModel, "_KIND", 'interface');
   ...
   */
  var ICommandCallback = /*#__PURE__*/_createClass(function ICommandCallback() {
    _classCallCheck(this, ICommandCallback);
    /**
     * 시작 콜백
     * 
     * @member {function[][]}
     */
    _defineProperty(this, "cbBegin", [[Function]]);
    /**
     * 유효성 콜백
     * 
     * @member {function[][]}
     */
    _defineProperty(this, "cbValid", [[Function]]);
    /**
     * 바인드 콜백
     * 
     * @member {function[][]}
     */
    _defineProperty(this, "cbBind", [[Function]]);
    /**
     * 결과 콜백
     * 
     * @member {function[][]}
     */
    _defineProperty(this, "cbResult", [[Function]]);
    /**
     * 출력 콜백
     * 
     * @member {function[][]}
     */
    _defineProperty(this, "cbOutput", [[Function]]);
    /**
     * 실행 종료 콜백
     * 
     * @member {function[][]}
     */
    _defineProperty(this, "cbEnd", [[Function]]);
  });
  _defineProperty(ICommandCallback, "_NS", 'Interface');
  // namespace
  _defineProperty(ICommandCallback, "_KIND", 'interface');
   ...
   */
  var IModelCallback = /*#__PURE__*/_createClass(function IModelCallback() {
    _classCallCheck(this, IModelCallback);
    /**
     * 실패 콜백
     * 
     * @member {function[][]}
     */
    _defineProperty(this, "cbFail", [[Function]]);
    /**
     * 오류 콜백
     * 
     * @member {function[][]}
     */
    _defineProperty(this, "cbError", [[Function]]);
    /**
     * 기본 시작 콜백
     * 
     * @member {function[][]}
     */
    _defineProperty(this, "cbBaseBegin", [[Function]]);
    /**
     * 기본 유효성 콜백
     * 
     * @member {function[][]}
     */
    _defineProperty(this, "cbBaseValid", [[Function]]);
    /**
     * 기본 바인드 콜백
     * 
     * @member {function[][]}
     */
    _defineProperty(this, "cbBaseBind", [[Function]]);
    /**
     * 기본 결과 콜백
     * 
     * @member {function[][]}
     */
    _defineProperty(this, "cbBaseResult", [[Function]]);
    /**
     * 기본 출력 콜백
     * 
     * @member {function[][]}
     */
    _defineProperty(this, "cbBaseOutput", [[Function]]);
    /**
     * 기본 실행 종료 콜백
     * 
     * @member {function[][]}
     */
    _defineProperty(this, "cbBaseEnd", [[Function]]);
  });
  _defineProperty(IModelCallback, "_NS", 'Interface');
  // namespace
  _defineProperty(IModelCallback, "_KIND", 'interface');
   ...
   * @constructs IService
   */
  var IService = /*#__PURE__*/_createClass(function IService() {
    _classCallCheck(this, IService);
    /**
     * 테이블
     * 
     * @member {object[][]}
     */
    _defineProperty(this, "tables", [[String, [String], {}]]);
    /**
     * 매핑 컬렉션
     * 
     * @member {object[][]}
  ...
  _defineProperty(IService, "_UNION", [IBindModel, IModelCallback]);
  _defineProperty(IService, "_NS", 'Interface');
  _defineProperty(IService, "_KIND", 'interface');
   ...
   */
  var IAjaxService = /*#__PURE__*/function (_IService) {
    function IAjaxService() {
      var _this;
      _classCallCheck(this, IAjaxService);
      _this = _callSuper(this, IAjaxService);
      /**
       * 기본 AJAX Setup 객체
       * 
       * @member {object[][]}
       */
      _defineProperty(_this, "baseConfig", [[{}]]);
      /**
       * 기본 요청 url
       * 
       * @member {string[][]}
       */
      _defineProperty(_this, "url", [[String]]);
      return _this;
    }
    _inherits(IAjaxService, _IService);
    return _createClass(IAjaxService);
  }(IService);
  _defineProperty(IAjaxService, "_NS", 'Interface');
  // namespace
  _defineProperty(IAjaxService, "_KIND", 'interface');
  ...
  function detectElementType(selector) {
    ...
    // 2. HTML 콘텐츠 검사
    var html = ((_elem$innerHTML = elem.innerHTML) === null || _elem$innerHTML === void 0 ? void 0 : _elem$innerHTML.trim()) || '';
    var hasHtmlTag = /<[^>]+>/.test(html);
    ...
    function HTMLColumn(p_name, p_entity, p_option) {
      ...
      Object.defineProperty(this, 'domType', {
        ...
        set: function set(nVal) {
          ...
          if (_typeof(nVal) !== 'object') throw new ExtendError(/EL054601/, null, [this.constructor.name]);
          domType = nVal;
        },
        configurable: true,
        enumerable: true
      ...
      Object.defineProperty(this, 'element', {
        ...
        set: function set(nVal) {
          // TODO: DOM 인스턴스 여부로 검사해야함
          if (_typeof(nVal) !== 'object') throw new ExtendError(/EL054604/, null, [this.constructor.name]);
          element = nVal;
        },
        configurable: true,
        enumerable: true
      ...
      Object.defineProperty(this, 'value', {
        get: function get() {
          ...
          if (typeof this.getter === 'function') {
            ...
            var isNode = typeof process !== 'undefined' && process.versions !== null && process.versions.node !== null && globalThis.isDOM !== true;
            // node 에서는 강제 종료함
            if (!isNode) {
        ...
        set: function set(val) {
          ...
          // else __val = val;
          if (typeof this.setter === 'function') __val = this.setter.call(this, val) || val;else __val = val;
      ...
      // 아이템 옵션속성 추가
      if (_typeof(p_option) === 'object') {
        for (var prop in p_option) {
          // POINT: get/setFilter 는 후처리해야함
          if (p_option.hasOwnProperty(prop) && ['domType', 'isReadOnly', 'isHide', 'element', 'selector', 'getFilter', 'setFilter'].indexOf(prop) > -1) {
  ...
  var BaseBindCommand = function (_super) {
    ...
    function BaseBindCommand(p_BaseBindModel, p_baseTable) {
      ...
      Object.defineProperty(this, 'outputOption', {
        ...
        set: function set(nVal) {
          if (typeof nVal === 'number') outputOption['option'] = nVal;else if (_typeof(nVal) === 'object') {
    ...
    function _isObject(obj) {
      if (_typeof(obj) !== null && _typeof(obj) === 'object') return true;
      return false;
    }
    ...
    function _getColumnName(itemName) {
      var cName;
      if (itemName.indexOf('.') > -1) cName = itemName.split('.')[1];else cName = itemName;
    ...
    BaseBindCommand.prototype.addColumn = function (p_column, p_views, p_bTable) {
      ...
      // 2.초기화 설정
      if (Array.isArray(p_views)) views = p_views;else if (typeof p_views === 'string') views.push(p_views);
      // $all 일 경우 빈배열로 변경
      if (views.some(function (elem) {
        if (!_isString(elem)) throw new ExtendError(/EL061319/, null, [i, _typeof(views[i])]);
      ...
      if (_isString(p_column)) column = new this._model._columnType(p_column, table);else column = p_column;
      ...
      if (views.length > 0) {
        for (var i = 0; i < views.length; i++) {
          // 속성 유무 검사
          if (this[views[i]]) property.push(views[i]);else throw new ExtendError(/EL061320/, null, [i, views[i]]);
        }
      } else {
    ...
    BaseBindCommand.prototype.addColumnValue = function (p_name, p_value, p_views, p_bTable) {
      ...
      // 유효성 검사
      if (!_isString(p_name)) {
        throw new ExtendError(/EL061321/, null, [_typeof(p_name)]);
      }
      // if (p_bTable && !(p_bTable instanceof MetaTable)) {
      //     throw new Error('Only [p_bTable] type "MetaTable" can be added');
      // }
      ...
      if (_isObject(p_value)) property = p_value;else property = {
        value: p_value
      };
      if (!(table instanceof MetaTable)) {
    ...
    BaseBindCommand.prototype.setColumn = function (p_names, p_views, p_bTable) {
      ...
      // 초기화
      if (Array.isArray(p_names)) names = p_names;else if (typeof p_names === 'string') names.push(p_names);
      ...
      for (var i = 0; names.length > i; i++) {
        ...
        if (!_isString(itemName)) {
          throw new ExtendError(/EL061323/, null, [i, _typeof(itemName)]);
        }
        ...
        if (tableName) table = this._model._tables[tableName];else if (typeof p_bTable === 'string') table = this._model._tables[p_bTable];else table = p_bTable || this._baseTable;
        if (!(table instanceof MetaTable)) {
    ...
    BaseBindCommand.prototype.release = function (p_names, p_views) {
      ...
      // 초기화
      if (Array.isArray(p_names)) names = p_names;else if (_isString(p_names)) names.push(p_names);
      // 1. 유효성 검사
      ...
      // $all 일 경우 빈배열로 변경
      if (views.some(function (elem) {
        if (!_isString(elem)) throw new ExtendError(/EL061329/, null, [i, _typeof(views[i])]);
        if (_isAllName(elem)) return true;
        return false;
      })) views.length = 0;
      ...
      if (views.length > 0) {
        for (var i = 0; i < views.length; i++) {
          viewName = views[i];
          if (!_isString(viewName)) throw new ExtendError(/EL061329/, null, [i, _typeof(viewName)]);
          // 속성 유무 검사
          if (this[viewName]) property.push(viewName);else throw new ExtendError(/EL061330/, null, [viewName]);
        }
      } else {
        property = ['valid', 'bind', 'misc'];
        for (var j = 0; j < this._outputs.count; j++) {
    ...
    BaseBindCommand.prototype.newOutput = function (p_name) {
      ...
      // 유효성 검사
      if (p_name && !_isString(p_name)) throw new ExtendError(/EL061331/, null, [_typeof(p_name)]);
      ...
      if (_isString(p_name)) {
        if (!$checkDoubleName(p_name)) {
          throw new ExtendError(/EL061332/, null, [_typeof(p_name)]);
        }
        this.$newOutput.push({
          cmdName: p_name,
          viewName: cntName
    ...
    BaseBindCommand.prototype.removeOutput = function (p_name) {
      ...
      var view;
      var pos;
      if (!_isString(p_name)) throw new ExtendError(/EL061333/, null, [_typeof(p_name)]);
      view = this[p_name];
  ...
  var BindCommand = function (_super) {
    ...
    function BindCommand(p_BaseBindModel, p_outputOption, p_baseTable) {
      ...
      var config = {
        ...
        // 요청 경로
        method: null,
        // 전송 방법 : GET, POST TODO: method 교체 요망
    ...
    function _isObject(obj) {
      if (obj !== null && _typeof(obj) === 'object') return true;
      return false;
    }
    ...
    BindCommand.prototype._execValid = function () {
      ...
      // }
      if (!bReturn) {
        // undefind 는 종료하지만, 실패 처리는 하지 않는다.
    ...
    BindCommand.prototype._execOutput = function (p_data, p_res) {
      ...
      if ($isEntitySchema(data)) {
        ...
        if (Array.isArray(data)) {
          ...
          throw new ExtendError(/EL06163/, null, [_typeof(data)]);
        }
      }
      ...
      function $setOutputValue(rowIdx, i) {
        if (typeof rowIdx !== 'number') throw new ExtendError(/EL06164/, null, [i, _typeof(rowIdx)]);
    ...
    BindCommand.prototype._ajaxCall = function (p_config) {
      ...
      if (p_config.method === 'GET') {
        ...
        // 데이터 전송 여부 확인 필요
        return axios.get(p_config.url, config).then(function (res) {
          _this._ajaxSuccess.call(_this, res.data, res.status, res);
        })["catch"](function (err) {
          _this._execError.call(_this, err, err.status, err.response);
          _this._execEnd(err.status, err.response);
        });
      } else if (p_config.method === 'DELETE') {
        // 삭제
        return axios["delete"](p_config.url, p_config.data, config).then(function (res) {
          _this._ajaxSuccess.call(_this, res.data, res.status, res);
        })["catch"](function (err) {
          _this._execError.call(_this, err, err.status, err.response);
          _this._execEnd(err.status, err.response);
        ...
        // 추가
        return axios.post(p_config.url, p_config.data, config).then(function (res) {
          _this._ajaxSuccess.call(_this, res.data, res.status, res);
        })["catch"](function (err) {
          _this._execError.call(_this, err, err.status, err.response);
          _this._execEnd(err.status, err.response);
        });
      } else if (p_config.method === 'PUT') {
        // 수정 
        return axios.put(p_config.url, p_config.data, config).then(function (res) {
          _this._ajaxSuccess.call(_this, res.data, res.status, res);
        })["catch"](function (err) {
          _this._execError.call(_this, err, err.status, err.response);
          _this._execEnd(err.status, err.response);
        });
      } else if (p_config.method === 'PATCH') {
        // 일부 수정
        return axios.patch(p_config.url, p_config.data, config).then(function (res) {
          _this._ajaxSuccess.call(_this, res.data, res.status, res);
        })["catch"](function (err) {
          _this._execError.call(_this, err, err.status, err.response);
          _this._execEnd(err.status, err.response);
    ...
    BindCommand.prototype._ajaxSuccess = function (p_data, p_status, p_res) {
      ...
      var data;
      try {
        data = _typeof(p_data) === 'object' ? p_data : JSON.parse(JSON.stringify(p_data));
    ...
    BindCommand.prototype.execute = function (p_outOpt, p_config) {
      ...
      try {
        ...
        // config 설정
        if (_isString(p_config)) this.url = p_config;else if (_isObject(p_config)) this.config = p_config;
        this._execBegin();
        if (!this._execValid()) {
  ...
  var BaseBindModel = function (_super) {
    ...
    function BaseBindModel() {
      ...
      var cbFail = function cbFail(msg, valid) {
        console.warn('Failed. Err:' + msg, valid);
      };
      var cbError = function cbError(msg, status, response) {
        console.error('An error has occurred. : ' + msg, status, response);
      };
      var cbBaseBegin;
      var cbBaseValid;
      var cbBaseBind;
      ...
      var cbBaseOutput;
      var cbBaseEnd;
      var preRegister = function preRegister() {};
      var preCheck = function preCheck() {
        return true;
      };
      var preReady = function preReady() {};
      ...
      Object.defineProperty(this, 'columns', {
        get: function get() {
          return this._baseTable.columns;
        },
        configurable: false,
        enumerable: true
      });
    ...
    BaseBindModel.prototype._readItem = function (p_items, p_bEntity) {
      ...
      // 1. 초기화
      if (Array.isArray(p_items)) items = items.concat(p_items);else if (_isString(p_items)) items.push(p_items);else throw new ExtendError(/EL061218/, null, []);
      ...
      for (var i = 0; items.length > i; i++) {
        ...
        columnName = _getColumnName(itemName);
        tableName = _getTableName(itemName);
        if (tableName) table = this._tables[tableName];else if (_isString(p_bEntity)) table = this._tables[p_bEntity];else table = p_bEntity || this._baseTable;
        ...
        if (['number', 'string', 'boolean'].indexOf(_typeof(this.items[itemName])) > -1) {
    ...
    BaseBindModel.prototype.addTable = function (p_name) {
      ...
      // 유효성 검사
      if (!_isString(p_name)) throw new ExtendError(/EL061224/, null, [_typeof(p_name)]);
      // 예약어 검사
    ...
    BaseBindModel.prototype.addColumn = function (p_column, p_cmds, p_views, p_bTable) {
      ...
      // 2. 초기값 설정
      if (Array.isArray(p_cmds)) cmds = p_cmds;else if (_isString(p_cmds)) cmds.push(p_cmds);
      ...
      if (_isString(p_column)) column = new this._columnType(p_column, table);else column = p_column;

      // 3. command 확인
      if (typeof p_cmds !== 'undefined' && cmds.length > 0) {
        for (var i = 0; i < cmds.length; i++) {
          if (!_isString(cmds[i])) throw new ExtendError(/EL061230/, null, [i, _typeof(cmds[i])]);
          if (_isAllName(cmds[i])) {
            for (var j = 0; j < this.command.count; j++) {
              var cmdName = this.command.indexToKey(j);
      ...
      for (var k = 0; k < command.length; k++) {
        // 명령 없을시 추가
        var _cmdName = command[k];
        if (!this.command.exists(_cmdName)) this.addCommand(_cmdName);
        // 명령에 컬럼 추가
        this.command[_cmdName].setColumn(column.columnName, p_views, table);
      }
    };
    ...
    BaseBindModel.prototype.addColumnValue = function (p_name, p_value, p_cmds, p_views, p_bEntity) {
      ...
      // 유효성 검사
      if (!_isString(p_name)) {
        throw new ExtendError(/EL061232/, null, [_typeof(p_name)]);
      }
      columnName = _getColumnName(p_name);
      tableName = _getTableName(p_name);
      if (tableName) {
    ...
    BaseBindModel.prototype.setMapping = function (p_mapping, p_bEntity) {
      ...
      function $processMapping(mappingCollection, i, p_bEntity, isAllCommand) {
        ...
        if (tableName) {
          if (!this._tables.exists(tableName)) this.addTable(tableName);
          table = this._tables[tableName];
        } else if (_isString(p_bEntity)) table = this._tables[p_bEntity];else table = p_bEntity || this._baseTable;
        if (!(table instanceof MetaTable)) {
          throw new ExtendError(/EL061235/, null, []);
        }
        if (!table.columns.exists(columnName)) {
    ...
    BaseBindModel.prototype.setService = function (p_service, p_passTypeChk) {
      ...
      // tables 등록
      if (p_service['tables']) {
        if (Array.isArray(p_service['tables'])) tables = p_service['tables'];else if (_isString(p_service['tables'])) tables.push(p_service['tables']);else throw new ExtendError(/EL061239/, null, []);
          ...
          if (propObject.hasOwnProperty(prop) && typeof propObject[prop] !== 'undefined') {
            ...
            if (propObject[prop]['views']) {
              ...
              if (!Array.isArray(views)) {
                throw new ExtendError(/EL061241/, null, [_typeof(views)]);
              }
            ...
            if (_typeof(propObject[prop]['config']) === 'object') command['config'] = propObject[prop]['config'];
  ...
  var BindModel = function (_super) {
    ...
    BindModel.prototype.addCommand = function (p_name, p_option, p_bTable) {
      ...
      try {
        // 유효성 검사
        if (!_isString(p_name)) throw new ExtendError(/EL06155/, null, [_typeof(p_name)]);
        if (_isString(p_bTable)) table = this._tables[p_bTable];else table = p_bTable || this._baseTable;
    ...
    BindModel.prototype.addSelector = function (p_name, p_selector, p_cmds, p_views, p_bTable) {
      ...
      try {
        if (_isObject(p_selector) && p_selector.key && p_selector && p_selector.type) {
          ...
          throw new ExtendError(/EL06159/, null, [_typeof(p_selector)]);
        }
    ...
    BindModel.prototype.setService = function (p_service, p_passTypeChk) {
      ...
      try {
        ...
        // base
        if (_typeof(p_service['baseConfig']) === 'object') {
